...
function loadJS(name) {
	...
	element.setAttribute('src', '/var/usr/palm/applications/com.youjf.justinput/justinput/' + name + '.js');
...
function loadCSS() {
	...
	element.setAttribute('href', '/var/usr/palm/applications/com.youjf.justinput/justinput/canvas.css');
